...
export function CharacterCard({
  ...
  return (
    <div className="w-full lg:min-w-80 lg:w-1/6 cursor-pointer">
      <Link to="/home">
        <BackgroundGradient className="rounded-[22px] p-4 sm:p-8 bg-white dark:bg-zinc-900 lg:h-64 text-center">
          <p className="sm:text-xl font-bold lg:text-2xl text-black mt-4 mb-2 dark:text-neutral-200">
            {name}
          </p>
          <p className="lg:mt-10 sm:text-lg text-black mt-4 mb-2 dark:text-neutral-200">
